...
```markdown
[Диаграмма контекста](recources/context.puml)
```
...
```markdown
[Диаграмма контейнеров](recources/container.puml)
```
Добавьте диаграмму.

```markdown
[Диаграмма компонентов](recources/component_3.puml)
```

Добавьте диаграмму для каждого из выделенных микросервисов.

```markdown
[Диаграмма кода](recources/code.puml)
```
...
```markdown
[Диаграмма ER](recources/EN.puml)
```

Collector - это сущность отвечающая за сбор телеметрии с датчиков и приборов. По сути, это микросервис.
Каждый коллектор взаимодействует с определенным количеством устройств, ограниченным георафическим положением: 
город(район/дом).